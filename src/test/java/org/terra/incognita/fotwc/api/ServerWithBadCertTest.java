...
class ServerWithBadCertTest extends HTTPSServerBase {

    /**
     * Simple log4j2 logger
     */
    private static final Logger log = LogManager.getLogger(ServerWithBadCertTest.class);
    ...
    void inspectConnection() {
        ...
        InspectionStatus.StatusCode statusCode = im.inspectConnection("localhost",8443,
                "FFFFCC87A3866565C83FC1A90A1E194521E51B50");
